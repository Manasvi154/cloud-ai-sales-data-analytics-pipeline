...
Fast path: use the automated deploy script first (`infra/scripts/deploy_phase1.ps1`) to provision the Phase 1 foundation, then continue with phase-specific hardening from this runbook.
